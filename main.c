        ...
        switch (mode){
            ...
            case 2:
                if (Timer(&time3,200)){
                    switch (rxdata) {
                        case '1': mode = 1; break;
                        case '2': tien();savemode = '2'; break;        
                        case '3': lui();savemode = '3'; break;        
                        case '4': quaytrai();savemode = '4'; break;     
                        case '5': quayphai();savemode = '5'; break;     
                        case '6': tien_re_trai();savemode = '6'; break;
                        case '7': tien_re_phai();savemode = '7'; break;
                        case '8': dung();savemode = '8'; break;
                        default:
                            if(savemode == '2'){
                                tien();    
                            }
